...
These writings aim to envision an optimistic future for Sri Lanka and outline a vision with the rationale to to substantiate it.  It defines a unique conceptual framework of the problem space that facilitates effective solutions and strategy.  It helps you start with the end in mind with an understanding of why we chose that end.
